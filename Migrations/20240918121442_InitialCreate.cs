        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedMessageText = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NfaCodes", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EncryptedMessages_UserId",
                table: "EncryptedMessages",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_NfaCodes_UserId",
                table: "NfaCodes",
                column: "UserId");
        }
